let menSingleDraw = [
    ...
    [ // Winner A
        {player1: "Michi", result1: "6:4 6:2", className: "wA"},
    ],
    [ // Round 2 B
    ...
    [ // Final B
        {player1: "Andi", result1: "1:6 7:5 6:4", player2: "Herbert", result2: "6:0 6:1", className: "fB"},
    ],
    [ // Winner B
        {player1: "Herbert", result1: "3:6 6:0 10:7", className: "wB"},
    ],
    [ // Semifinal C
...
let menDoubleDraw = [
    ...
    [ // Winner A
        {player1: "Michi / Lukas L.", result1: "7:5 6:2", className: "wA"},
    ],
    [ // Round 2 B
    ...
    [ // Winner B
        {player1: "Peter P. / Paul", result1: "6:4 0:6 10:6", className: "wB"},
    ],
];
...
let womenSingleDraw = [
    ...
    [ // Final A
        {player1: "Helga", result1: "6:0 6:2", player2: "Lea", result2: "6:3 4:6 6:2", className: "fA"},
    ],
    [ // Winner A
        {player1: "Lea", result1: "6:1 6:2", className: "wA"},
    ],
    [ // Round 2 B
    ...
    [ // Semifinal B
        {player1: "Andrea", result1: "6:2 6:2", player2: "Amelie", result2: "(2)", className: "sB1"},
        {player1: "Marlene", result1: "6:2 5:7 6:1", player2: "Karin", result2: "(1)", className: "sB2"},
    ],
    [ // Final B
        {player1: "Amelie", result1: "6:0 6:2", player2: "Karin", result2: "6:3 6:0", className: "fB"},
    ],
    [ // Winner B
        {player1: "Amelie", result1: "6:3 6:2", className: "wB"},
    ],
];
