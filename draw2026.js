const menSingleDraw = new Tournament("Herren Einzel", [
    ...
    new Round("Semifinal A", [
        new Match("Thomas", "David L.", "6:1 6:1", "6:1 6:3", "sA1"),
        new Match("Jakob", "Peter", "6:1 6:2", "6:1 6:1", "sA2"),
    ]),
    new Round("Final A", [
        new Match("Thomas", "Jakob", "6:0 6:0", "w. o.", "fA")
    ]),
    new Round("Winner A", [
        new Match("Thomas", "", "6:1 6:0", "", "wA")
    ]),
    new Round("Round 2 B", [
    ...
    new Round("Quarterfinal B", [
        ...
        new Match("Bye", "Constantin", "", "(2)", "qB4"),
    ]),
    new Round("Semifinal B", [
        new Match("Lukas", "Martin", "", "6:3 6:4", "sB1"),
        new Match("Colin", "Constantin", "", "", "sB2"),
    ]),
    new Round("Final B", [
        new Match("Lukas", "Colin", "6:2 6:4", "6:2 6:0", "fB")
    ]),
...
const womenSingleDraw = new Tournament("Damen Einzel", [
    ...
    new Round("Final B", [
        new Match("Karin", "Emma", "6:0 7:5", "7:6 7:5", "fB")
    ]),
    new Round("Winner B", [
        new Match("Emma", "", "6:4 6:4", "", "wB")
    ])
])
...
const menDoubleDraw = new Tournament("Herren Doppel", [
    ...
    new Round("Winner A", [
        new Match("Thomas / David", "", "6:3 6:2", "", "wA")
    ]),
    new Round("Round 2 B", [
...
const womenDoubleDraw = new Tournament("Damen Doppel", [
    new Round("Round Robin", [
        ...
        new Match("Amelie / Edith", "Sophie / Valentina", "6:1 6:2", "", "rr3"),
        new Match("Amelie / Edith", "Emma / Karin", "2:6 6:4 12:10", "", "rr4"),
        new Match("Amelie / Edith", "Rosa / Marlene", "5:7 2:6", "", "rr5"),
        new Match("Sophie / Valentina", "Emma / Karin", "4:6 3:6", "", "rr4"),
        new Match("Sophie / Valentina", "Rosa / Marlene", "5:7 6:3 9:11", "", "rr5"),
...
const roundRobinData = [
    ...
    { name: "Amelie / Edith", spiele: 3, siege: 2, saetze: "4:2", games: "27:26" },
    { name: "Rosa / Marlene", spiele: 3, siege: 2, saetze: "4:2", games: "27:30" },
    { name: "Emma / Karin", spiele: 4, siege: 2, saetze: "4:4", games: "36:31" },
    { name: "Sophie / Valentina", spiele: 4, siege: 0, saetze: "1:8", games: "26:46" },
];